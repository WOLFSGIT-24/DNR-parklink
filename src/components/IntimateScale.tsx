        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          ...
          <div className="lg:col-span-5 space-y-4 text-center lg:text-left">
            ...
            <h2 className="font-display text-3xl sm:text-4xl text-navy-primary font-semibold leading-tight">
              More Space. More Light. More to Live For.
            </h2>
            ...
            <p className="font-body text-sm md:text-base text-gray-text leading-relaxed pt-2">
              Thoughtfully planned across 8.35 acres, DNR Parklink brings together 784 well-designed residences with 70% open space. Spacious homes, well-ventilated interiors and lush, Singapore-inspired landscaping create a balanced environment designed for comfortable everyday living.
            </p>
