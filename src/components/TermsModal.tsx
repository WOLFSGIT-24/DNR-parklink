      ...
      >
        ...
        <div className="flex justify-between items-center p-6 sm:p-8 border-b border-navy-primary/5 bg-marble shrink-0">
          <div>
            ...
            <p className="font-body text-xs text-charcoal/60 mt-1 uppercase tracking-widest">DNR Parklink Collective</p>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="p-6 sm:p-8 overflow-y-auto font-body text-sm text-charcoal/80 leading-relaxed space-y-8 custom-scrollbar">
          ...
          <div className="space-y-4">
            <p>
              By accessing and using this website, you agree to be bound by these Terms and Conditions. This website is operated by the DNR Parklink Collective, an authorised marketing partner for DNR Group.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <p>
              This website has been created for the sole purpose of providing information and generating enquiries for DNR Parklink, a boutique community of premium residences in North Bangalore. This is an authorised marketing website and operates in accordance with developer guidelines.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <p>
              By submitting your contact details through any form on this website, you consent to being contacted by our team and/or the authorised DNR Parklink sales team via phone, email, SMS, or WhatsApp regarding the project.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <p>
              All content on this website including text, images, logos, and design is either owned by or licensed to DNR Group and their respective marketing partners. Unauthorised reproduction, distribution, or modification of any material on this site is strictly prohibited.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <p>
              In no event shall DNR Group or their authorised marketing partners be liable for any direct, indirect, incidental, or consequential damages arising from the use of this website or reliance on any information provided herein.
            </p>
          </div>
