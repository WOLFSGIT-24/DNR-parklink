...
export default function BrochureForm({ onAddLead, preselectedUnit }: BrochureFormProps) {
  ...
  const handleDownloadBrochure = () => {
    try {
      ...
      link.setAttribute("download", "DNR_Parklink_Brochure.pdf");
                ...
                <>
                  <div className="mb-8">
                    ...
                    <p className="font-body text-xs text-gray-text mt-1">
                      Experience the project, understand the floor plans and explore the lifestyle that DNR Parklink has to offer.
                    </p>
                  </div>
