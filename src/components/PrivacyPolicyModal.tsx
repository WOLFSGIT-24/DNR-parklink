      ...
      >
        ...
        <div className="p-6 sm:p-8 overflow-y-auto font-body text-sm text-charcoal/80 leading-relaxed space-y-8 custom-scrollbar">
          ...
          <div className="space-y-4">
            <p>
              This website is operated by DNR Parklink Collective, the authorised marketing channel for DNR Parklink, a boutique community of premium residences in North Bangalore. We are committed to protecting the privacy of every visitor to this website and handling your personal information with care, transparency, and respect.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="list-disc pl-5 space-y-1">
              <li>Responding to your enquiry about DNR Parklink</li>
              <li>Sharing digital brochures, floor plans, and project details</li>
              <li>Connecting you with the authorised DNR Parklink sales team</li>
          ...
          <div className="space-y-4">
            ...
            <p>We may share your information with DNR Group and their authorised sales representatives for the sole purpose of fulfilling your enquiry and following up on your interest in this project.</p>
            <p>We do not sell, rent, or trade your personal data to any third parties for marketing purposes unrelated to DNR Parklink or DNR Group projects.</p>
          </div>
