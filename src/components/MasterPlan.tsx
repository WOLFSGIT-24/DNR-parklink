      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="text-center max-w-2xl mx-auto mb-12 space-y-4">
          ...
          <h2 className="font-display text-3xl sm:text-4xl text-navy-primary font-semibold leading-tight">
            Thoughtfully Planned. Seamlessly Connected.
          </h2>
          ...
          <p className="font-body text-sm md:text-base text-gray-text leading-relaxed">
            Explore the thoughtfully planned spaces of DNR Parklink, where every level is designed to bring together everyday convenience, movement and community living. From landscaped ground-level spaces to thoughtfully planned podium and rooftop areas, discover a master plan designed around the needs of modern residents.
          </p>
        </div>
